...
"Semester,Classroom,Campus,Modality,ApplicationUser,MeetingTime,DayBlock,PartOfTerm,PayModel,WhoPays,SectionStatus")
            ...
            IEnumerable<ApplicationUser> applicationUsers = _unitOfWork.ApplicationUser.GetAll(); //filter for instructors
            ...
            foreach (Section s in sections)
            {
                ...
                s.Classroom.Building.Campus = campuses.FirstOrDefault(c => c.CampusId == s.Classroom.Building.CampusId);
