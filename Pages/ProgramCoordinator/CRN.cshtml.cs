...
{
    public class CRNModel : PageModel
    {
        ...
        public CRNModel(UnitOfWork unit, UserManager<ApplicationUser> userManager)
        {
        ...
        public IActionResult OnPost(int? id)
        {
            ...
            else //item exists already - EDIT MODE
            {
                ...
                //objSection = _unitOfWork.Section.GetById(objSection.SectionId);
                _unitOfWork.Section.Update(objSection);

            }
            // objSection = _unitOfWork.Section.GetById(sectionId);
            // save changes to db. 
            _unitOfWork.Commit();
        ...
        public void OnGet(int id)
        {
            ...
            int courseId = objSection.CourseId;
